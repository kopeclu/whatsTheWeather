...
### **.css files**
    For those files isn't created special folder, because there is only 3 of them and the project is still readable.  This fact is true also thanks to naming of those files.
...
1. #### **Files in the background**
       These files are not visible on the actual page but are crutial for developing and running the App
...
2. #### Files in the front 
       These are the files containing all the content displayed to the user (but it has also its section hidden to the user)
